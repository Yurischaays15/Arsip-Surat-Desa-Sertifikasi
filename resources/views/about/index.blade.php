...
<html lang="en">
    <head>
        ...
        <title>About - SERTIFIKASI DIPA 2022</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card" style="max-width: 540px;"><br>
                            <div class="row no-gutters"><br>
		                        <div class="col-md-4">
                                    </p></p>
			                        <img class="card-img" src="img/fotobaru.png">
                                    </p></p>
                                </div>
		                        <div class="col-md-8">
			                        <div class="card-body">
                                        <h5 class="card-title">Aplikasi ini dibuat oleh:</h5>
                                        <p class="card-text">   Nama    : Yurischa Aulya Firnanda <br>
                                                                NIM     : 1931710035 <br>
